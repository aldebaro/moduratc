...
bwPSK=Rsym*(1+r); %theoretical null-to-null BW. TODO: use another definition
numOutputFiles=10;
outputPath=ff.myBasebandCenvTimeDomainDir; %output directory for files
for i=1:numOutputFiles
    outputFileName=[outputPath 'pskFs' num2str(dsp.Fs_bb/1e3) ...
        'kHzBw' num2str(bwPSK/1e3) 'kHz_' num2str(i) '.' ff.basebandEnvelopesFileExtension];
